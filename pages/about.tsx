  ...
  return (
    <Layout title="About | T. James Perry">
      ...
      <Paragraph size="md">
        ...
        From time-to-time, programmers, present themselves as lone artists. Their canvas is ones-and-zeros and logic itself, abstracted as a programming languages. Their brush is their mind and ego flowing into each fingertip, carving out each module with refined taste. Thankfully, people animated by this caricature, tend not be valued by effective engineering teams, for modern software engineering is a social exercise. High performing teams hire for the engineers who can use their intelligence to contribute to a team in a scalable manner. Scalable behavior in an engineering context equates being an owner, efficient communicaton, iterative development, refining and following shared standards and processes, and applying SOLID design principles.
      </Paragraph>
    </Layout>
  );
}
